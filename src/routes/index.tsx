...
export default function HomePage() {
  return (
    <>
      <Helmet>
        {/* Title */}
        <title>KM Biosciences | Pharmaceutical Quality & Regulatory Services | UK & Ireland</title>

        {/* Meta Description */}
        <meta
          name="description"
          content="KM Biosciences is an MHRA and HPRA authorised MIA Holder providing Qualified Person (QP), Responsible Person (RP), RPi, Quality Assurance, Regulatory Affairs, GMP, GDP, eQMS and pharmaceutical compliance services across the UK, Ireland and Europe."
        />

        {/* Keywords */}
        <meta
          name="keywords"
          content="KM Biosciences, KMBiosciences, Pharmaceutical Quality Services, Pharmaceutical Regulatory Services, Qualified Person, QP Services, Responsible Person, RP Services, Responsible Person Import, RPi, MIA Holder, MHRA, HPRA, GMP, GDP, Regulatory Affairs, Regulatory Compliance, Pharmaceutical Compliance, Quality Assurance, QA, Lead Auditor, eQMS, Scilife, Batch Certification, Batch Release, Pharmaceutical Services UK, Pharmaceutical Services Ireland, EU Pharmaceutical Services, Pharmaceutical Experts"
        />
        ...
        {/* Canonical */}
        <link rel="canonical" href="https://www.kmbios.com/" />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="KM Biosciences | Pharmaceutical Quality & Regulatory Services"
        />

        <meta
          property="og:description"
          content="MHRA & HPRA authorised MIA Holder providing Qualified Person (QP), Responsible Person (RP), RPi, Quality Assurance, Regulatory Affairs and pharmaceutical compliance services across the UK and Europe."
        />

        <meta property="og:url" content="https://www.kmbios.com/" />
        ...
        <meta
          ...
          content="Trusted pharmaceutical quality and regulatory services across the UK, Ireland and Europe."
        />
      ...
      <section className="relative overflow-hidden py-24">
        <div className="container-x">
          <div className="relative overflow-hidden rounded-[2rem] grad-hero p-10 shadow-elegant sm:p-16">
            <div
              aria-hidden
              className="absolute -right-24 -top-24 h-96 w-96 rounded-full bg-[color:var(--royal-purple)] opacity-40 blur-3xl"
            />
            <div
              aria-hidden
              className="absolute -bottom-24 -left-16 h-96 w-96 rounded-full bg-[color:var(--royal-blue)] opacity-40 blur-3xl"
            />
