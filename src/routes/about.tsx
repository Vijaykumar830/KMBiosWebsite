...
export default function AboutPage() {
  return (
    <>
      <Helmet>
        {/* Title */}
        <title>About KM Biosciences | MHRA & HPRA Authorised MIA Holder | UK & Ireland</title>

        {/* SEO Description */}
        <meta
          name="description"
          content="Learn about KM Biosciences Limited, an MHRA and HPRA authorised MIA Holder with over 20 years of pharmaceutical expertise, providing Qualified Person (QP), Responsible Person (RP), RPi, Quality Assurance, Regulatory Affairs, GMP, GDP and eQMS services across the UK, Ireland and Europe."
        />

        {/* Keywords */}
        <meta
          name="keywords"
          content="About KM Biosciences, KM Biosciences Limited, Pharmaceutical Services UK, Pharmaceutical Services Ireland, Qualified Person, QP, Responsible Person, RP, RPi, MIA Holder, MHRA, HPRA, Pharmaceutical Regulatory Services, Regulatory Affairs, GMP, GDP, Pharmaceutical Quality Assurance, Pharmaceutical Compliance, Lead Auditor, eQMS, Scilife, Pharmaceutical Experts"
        />
        ...
        {/* Canonical */}
        <link rel="canonical" href="https://www.kmbios.com/about" />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="About KM Biosciences | Pharmaceutical Quality & Regulatory Experts"
        />

        <meta
          property="og:description"
          content="Discover KM Biosciences, an MHRA & HPRA authorised MIA Holder delivering pharmaceutical quality, regulatory compliance, Qualified Person (QP), Responsible Person (RP), RPi and GMP/GDP services throughout the UK and Europe."
        />

        <meta property="og:url" content="https://www.kmbios.com/about" />

        <meta property="og:type" content="website" />

        <meta property="og:site_name" content="KMBiosciences Limited" />
        ...
        <meta
          name="twitter:title"
          content="About KM Biosciences | MHRA & HPRA Authorised MIA Holder"
        />

        <meta
          name="twitter:description"
          content="Learn about KM Biosciences, a trusted pharmaceutical quality and regulatory service provider supporting clients across the UK, Ireland and Europe."
        />
