...
export default function IndustriesPage() {
  return (
    <>
      <Helmet>
        {/* Title */}
        <title>Industries We Support | Pharmaceutical, Biotech & Healthcare | KM Biosciences</title>

        {/* Meta Description */}
        <meta
          name="description"
          content="KM Biosciences supports pharmaceutical manufacturers, biotechnology companies, Marketing Authorisation Holders (MAHs), Contract Manufacturing Organisations (CMOs), wholesale distributors, virtual pharmaceutical companies and start-ups with regulatory, quality and compliance services across the UK, Ireland and Europe."
        />

        {/* Keywords */}
        <meta
          name="keywords"
          content="Pharmaceutical Industry, Biotechnology Companies, Biotech Industry, Marketing Authorisation Holder, MAH, CMO, Contract Manufacturing Organisation, Wholesale Distributor, Virtual Pharmaceutical Companies, Pharmaceutical Startups, Life Sciences, Healthcare Industry, Pharmaceutical Manufacturing, Pharmaceutical Importation, Pharmaceutical Distribution, Pharmaceutical Quality Assurance, Regulatory Affairs, GMP, GDP, Qualified Person, Responsible Person, RPi, Pharmaceutical Compliance, UK Pharmaceutical Industry, Ireland Pharmaceutical Industry, European Pharmaceutical Industry, KM Biosciences"
        />
        ...
        {/* Canonical */}
        <link rel="canonical" href="https://www.kmbios.com/industries" />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="Industries We Support | Pharmaceutical & Biotech Services | KM Biosciences"
        />

        <meta
          property="og:description"
          content="Discover how KM Biosciences supports pharmaceutical manufacturers, biotechnology companies, MAHs, CMOs, wholesale distributors and healthcare organisations with expert quality, regulatory and compliance services."
        />

        <meta property="og:url" content="https://www.kmbios.com/industries" />
        ...
        <meta name="twitter:title" content="Industries We Support | KM Biosciences" />

        <meta
          name="twitter:description"
          content="Expert pharmaceutical quality, regulatory and compliance services supporting pharmaceutical, biotechnology and healthcare organisations across the UK, Ireland and Europe."
        />
      ...
      {/* Partnership laboratories & warehouses */}
